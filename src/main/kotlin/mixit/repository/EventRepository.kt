...
class EventRepository(val db: ReactiveMongoTemplate) {
    ...
    fun init() {
        ...
        db.insert(Event(5L, 2016, false, Instant.ofEpochMilli(1461218400000), Instant.ofEpochMilli(1461304800000))).subscribe()
        db.insert(Event(6L, 2017, true, Instant.ofEpochMilli(1461132000000), Instant.ofEpochMilli(1461261600000))).subscribe()
    }
