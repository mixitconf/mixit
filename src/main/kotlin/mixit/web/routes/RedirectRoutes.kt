...
fun redirectRouter(blogHandler: BlogHandler,
                   talkHandler: TalkHandler,
                   properties: MixitProperties) = router {

    val googleDriveUri = "https://drive.google.com/open"
    accept(TEXT_HTML).nest {
        ...
        GET("/docs/sponsor/leaflet/en") { permanentRedirect("$googleDriveUri?id=${properties.drive.en.sponsor}")}
        GET("/docs/sponsor/leaflet/fr") { permanentRedirect("$googleDriveUri?id=${properties.drive.fr.sponsor}")}
        GET("/docs/sponsor/form/en") { permanentRedirect("$googleDriveUri?id=${properties.drive.en.sponsorform}")}
        GET("/docs/sponsor/form/fr") { permanentRedirect("$googleDriveUri?id=${properties.drive.fr.sponsorform}")}
        GET("/docs/speaker/leaflet/en") { permanentRedirect("$googleDriveUri?id=${properties.drive.en.speaker}")}
        GET("/docs/speaker/leaflet/fr") { permanentRedirect("$googleDriveUri?id=${properties.drive.fr.speaker}")}
        GET("/docs/presse/leaflet/en") { permanentRedirect("$googleDriveUri?id=${properties.drive.en.press}")}
        GET("/docs/presse/leaflet/fr") { permanentRedirect("$googleDriveUri?id=${properties.drive.fr.press}")}
