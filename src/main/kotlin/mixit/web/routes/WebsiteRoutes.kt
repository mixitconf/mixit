...
class WebsiteRoutes(private val adminHandler: AdminHandler,
    ...
    fun websiteRouter() = router {
        ...
        accept(TEXT_HTML).nest {
            GET("/") { sponsorHandler.viewWithSponsors("home", arrayOf(SponsorshipLevel.LANYARD, SponsorshipLevel.GOLD), null, 2019, it) }
            ...
            GET("/mixteen") { sponsorHandler.viewWithSponsors("mixteen", arrayOf(SponsorshipLevel.MIXTEEN), "mixteen.title", 2019, it) }
